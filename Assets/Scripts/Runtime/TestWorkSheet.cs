...
/// 
[System.Serializable]
public class TestWorkSheet : ScriptableObject 
{
    ...
    public TestWorkSheetData[] dataArray;
...
//#endif
        ...
        // 
        if (dataArray == null)
            dataArray = new TestWorkSheetData[0];
    }
    
    //
    // Write a proper query methods for retrieving data.
    //
    //public TestWorkSheetData FindByKey(string key)
    //{
